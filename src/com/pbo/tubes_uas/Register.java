...
public class Register extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/pbo/tubes_uas/icons/Cover_Image.jpg"))); // NOI18N
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/pbo/tubes_uas/icons/logo.png"))); // NOI18N
        ...
        jLabel3.setText("Buat akunmu!");
        jPanel3.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 130, -1, -1));
        ...
        jPanel3.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 190, -1, 30));

        jLabel6.setBackground(new java.awt.Color(255, 255, 255));
        jLabel6.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel6.setText("Nama Tengah");
        jPanel3.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 240, -1, 30));
        ...
        jPanel3.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 390, 60, 30));
        ...
        jPanel3.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 340, 40, 30));
    ...
    private void btnRegisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegisterActionPerformed
        ...
        if(fname.isEmpty() && mname.isEmpty() && lname.isEmpty() && address.isEmpty() && username.isEmpty() && password.isEmpty()){
            JOptionPane.showMessageDialog(this, "Isi Form dengan lengkap", "Error", JOptionPane.ERROR_MESSAGE);
            ...
            JOptionPane.showMessageDialog(this, "Nama tengah kosong.", "Error", JOptionPane.ERROR_MESSAGE);
            
        }else if(lname.isEmpty()){
            
            JOptionPane.showMessageDialog(this, "Nama terakhir kosong.", "Error", JOptionPane.ERROR_MESSAGE);
            
        }else if (address.isEmpty()){
            
            JOptionPane.showMessageDialog(this, "Alamat kosong.", "Error", JOptionPane.ERROR_MESSAGE);
    ...
    private void userRegister(String fname, String mname, String lname, String address, String username, String password, String role) {
        ...
        try {
            ...
            System.out.println("Tidak ada koneksi tersedia.");
        }
    }
}
